...
public class GosenTriePatternTest {
	...
	@Theory
	public void test(final Fixture fixture) throws IOException {
		final List<String> needles = Arrays.asList(fixture.needles);
		final StringPattern pattern = GosenTriePattern.compile(needles);
